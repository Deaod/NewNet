class ST_ShockProjBlue extends ST_ShockProj;
...
{	
	...
	{
		if (Level.NetMode == NM_Client && !IsA('NN_ShockProjBlueOwnerHidden'))
		{
...
simulated function NN_Momentum( float DamageRadius, float Momentum, vector HitLocation )
{
	...
	if ( bbP == None || !bbP.bNewNet || Self.IsA('NN_ShockProjBlueOwnerHidden') || RemoteRole == ROLE_Authority )
		return;
