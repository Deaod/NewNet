class ST_SiegeInstaGibRifle extends ST_WildcardsWeapons;
...
simulated function InitGraphics()
{
	...
	{
		Spawn(class'ST_SiegeInstaGibLoader').TW = OrgClass;
	}
}
...
{
	Class'NNSetShock'.static.SetTeamSkins( self);
}
...
defaultproperties
{
     ...
     FireSound=Sound'SSSound'
     AltFireSound=Sound'SSSound'
