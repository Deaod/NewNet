...
defaultproperties
{
     ...
     LastMonth=1
     CurrentStats(0)=(taken=135,Special=5)
     CurrentStats(8)=(fired=402,Hits=86,Given=8600,taken=13365,Kills=86,Deaths=135,Special=7)
     MonthlyStats(0)=(taken=524,Deaths=1,Suicides=4,Special=5)
     MonthlyStats(8)=(fired=4554,Hits=996,Given=99600,taken=136076,Kills=996,Deaths=1362,Special=67)
     AllTimeStats(0)=(taken=127,Kills=1,Suicides=1,Special=2)
     AllTimeStats(8)=(fired=2923,Hits=544,Given=54400,taken=80273,Kills=544,Deaths=803,Special=41)
     ...
     MonthlySpreeCount(0)=17
     AllTimeSpreeCount(0)=3
     SpreeNames(0)="Killing Spree"
     SpreeNames(1)="Rampage"
     SpreeNames(2)="Dominating"
     SpreeNames(3)="Unstoppable"
     SpreeNames(4)="Godlike"
     CurrentMultiCount(0)=13
     CurrentMultiCount(1)=1
     MonthlyMultiCount(0)=102
     MonthlyMultiCount(1)=12
     MonthlyMultiCount(2)=1
     MonthlyMultiCount(3)=1
     AllTimeMultiCount(0)=63
     AllTimeMultiCount(1)=2
     AllTimeMultiCount(2)=2
     MultiNames(0)="Double Kills"
     MultiNames(1)="Multi Kills"
     MultiNames(2)="Ultra Kills"
     MultiNames(3)="MONSTER KILLS"
     CurrentCTFStats(0)=(Count=12,Special=9)
     CurrentCTFStats(1)=(Count=12,Special=12)
     CurrentCTFStats(3)=(Count=2)
     CurrentCTFStats(4)=(Count=1)
     MonthlyCTFStats(0)=(Count=177,Special=130)
     MonthlyCTFStats(1)=(Count=163,Special=163)
     MonthlyCTFStats(3)=(Count=56,Special=2)
     MonthlyCTFStats(4)=(Count=12)
     MonthlyCTFStats(5)=(Count=13,Special=7)
     AllTimeCTFStats(0)=(Count=94,Special=74)
     AllTimeCTFStats(1)=(Count=86,Special=86)
     AllTimeCTFStats(3)=(Count=54)
     AllTimeCTFStats(4)=(Count=5)
     AllTimeCTFStats(5)=(Count=7,Special=2)
     ...
     BGTex=Texture'NewNetUnrealv0_9_17.PureSWT'
}
